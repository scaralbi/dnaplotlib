...
pAST46 = [sp, J19, rbs, eYFP, term, sp]
pAST44 = [sp, Pr, ope, rbs, prqR, int, rbs, eYFP, term]
pAST45 = [sp, Pr, ope, rbs, eYFP, term]
pAST48 = [sp, J19, rbs, prqR, term, Pr, ope, rbs, eYFP, term]
neg = [sp, Pran, eYFP, term]
lac = [Plac, rbs, lacZ, term]
...
ax_dna1.set_yticks([])
ax_dna1.axis('off')
start, end = dr.renderDNA(ax_dna2, pAST44, part_renderers, regs=reg1, reg_renderers=reg_renderers)
...
ax_dna2.set_yticks([])
ax_dna2.axis('off')
start, end = dr.renderDNA(ax_dna3, pAST45, part_renderers)
...
ax_dna3.set_yticks([])
ax_dna3.axis('off')
start, end = dr.renderDNA(ax_dna4, pAST46, part_renderers)
...
ax_dna4.set_yticks([])
ax_dna4.axis('off')
start, end = dr.renderDNA(ax_dna5, pAST48, part_renderers, regs=reg1, reg_renderers=reg_renderers)
...
ax_dna5.set_yticks([])
ax_dna5.axis('off')
start, end = dr.renderDNA(ax_dna6, lac, part_renderers)
...
# Save the figure
fig.savefig('reporters5.png', transparent=True,  dpi=600)
